...
export function BlockPage() {
  ...
  const features = [
    { icon: "IconPlaceholder", title: "组件式模块化开发", description: "基于组件的灵活开发模式，提高代码复用性和维护性" },
    { icon: "IconPlaceholder", title: "全栈代码生成", description: "自动生成前端、后端和测试代码" },
    { icon: "IconPlaceholder", title: "自然语言理解", description: "通过对话即可完成复杂的开发任务" },
    { icon: "IconPlaceholder", title: "图像识别集成", description: "支持图片识别，快速转化设计为代码" },
    { icon: "IconPlaceholder", title: "实时协作", description: "多人实时协作，提高团队效率" },
    { icon: "IconPlaceholder", title: "持续学习", description: "AI持续学习，不断优化开发建议" },
    { icon: "IconPlaceholder", title: "ACE CLI 框架对接", description: "无缝集成ACE CLI框架，提升开发效率" },
    { icon: "IconPlaceholder", title: "CMS模板支持", description: "支持WordPress, Magento, Drupal等CMS模板开发" },
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-gray-800">
      <header className="fixed top-0 left-0 right-0 z-50 bg-white bg-opacity-90 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold text-blue-600">AI DevAssist</div>
          <nav>
            <ul className="flex space-x-6">
              <li><a href="#features" className="hover:text-blue-600 transition-colors">特性</a></li>
              <li><a href="#demo" className="hover:text-blue-600 transition-colors">演示</a></li>
              <li><a href="#cta" className="hover:text-blue-600 transition-colors">开始使用</a></li>
            </ul>
          </nav>
        </div>
      </header>
      ...
      <main className="pt-16">
        ...
        <section id="demo" className="container mx-auto px-4 py-20 bg-blue-50">
          ...
          <div className="aspect-video rounded-lg overflow-hidden shadow-xl">
            <img src="/placeholder.svg?height=720&width=1280" alt="Product Demo" className="w-full h-full object-cover" />
          </div>
        </section>
      ...
      <footer className="bg-gray-100 py-8">
        <div className="container mx-auto px-4 text-center text-sm text-gray-600">
          <p>&copy; 2024 AI DevAssist. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
