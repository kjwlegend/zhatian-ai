...
const foundersData = [
    {
      ...
      name: "孔经纬",
      role: "创始人 & 产品主负责人",
      avatar: "/images/kong-jingwei-avatar.jpg",
      image: "/images/kong-jingwei.jpg",
    ...
    },
    {
      ...
      name: "王晓波",
      role: "产品主负责人 & 首席前端工程师",
      avatar: "/images/wang-xiaobo-avatar.jpg",
      image: "/images/wang-xiaobo.jpg",
    ...
    },
    {
      ...
      name: "孔超",
      role: "架构师 & 产品后端负责人",
      avatar: "/images/kong-chao-avatar.jpg",
      image: "/images/kong-chao.jpg",
    ...
    },
    {
      ...
      avatar: "/images/zheng-chuanyang-avatar.jpg",
      image: "/images/zheng-chuanyang.jpg",
...
const FoundersPage: React.FC = () => {
  ...
  return (
    <Container size="xl" className="founders-page">
      <Title order={1} className="founders-title">创始人</Title>
      <FoundersCarousel 
